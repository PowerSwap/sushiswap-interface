import { ChainId, Currency, NATIVE, SUSHI_ADDRESS } from '@powerswap/sdk'
                ...
                <div className="fixed bottom-0 left-0 z-10 flex flex-row items-center justify-center w-full p-4 lg:w-auto bg-dark-1000 lg:relative lg:p-0 lg:bg-transparent">
                  <div className="flex items-center justify-between w-full space-x-2 sm:justify-end">
                              ...
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                const params: any = {
                                  ...
                                  options: {
                                    ...
                                    decimals: 18,
                                    image:
                                      'https://raw.githubusercontent.com/powerswap/assets/master/blockchains/ethereum/assets/0x8798249c2E607446EfB7Ad49eC89dD1865Ff4272/logo.png',
                                  },
                                }
                                library.provider
                                  .request({
                    ...
                    {chainId && chainId in SUSHI_ADDRESS && library && library.provider.isMetaMask && (
                      <>
                        <QuestionHelper text={i18n._(t`Add POWER to your MetaMask wallet`)}>
                          <div
                            ...
                            onClick={() => {
                              const params: any = {
                                ...
                                options: {
                                  ...
                                  decimals: 18,
                                  image:
                                    'https://raw.githubusercontent.com/PowerSwap/assets/master/blockchains/harmony/assets/0x14Ac72f5063Dcd01DdB1eC25Ed0880127a955366/logo.png',
                                },
                              }
                              if (library && library.provider.isMetaMask && library.provider.request) {
                                library.provider
                                  ...
                                  .then((success) => {
                                    if (success) {
                                      console.log('Successfully added POWER to MetaMask')
                                    } else {
                                      throw new Error('Something went wrong.')
                                    }
                                  })
                          ...
                          >
                            <Image
                              src="/images/tokens/power-square.png"
                              alt="POWER"
                              width="38px"
                              height="38px"
                              objectFit="contain"
