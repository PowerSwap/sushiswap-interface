import { Currency, CurrencyAmount, JSBI, Percent, Token, TradeType, Trade as V2Trade } from '@powerswap/sdk'
import { DAI, POWER, USDC } from '../constants/tokens'
...
const PERMITTABLE_TOKENS: {
  ...
  [1]: {
    ...
    [POWER[1].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  },
  [4]: {
    ...
    [POWER[4].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  },
  [3]: {
    [POWER[3].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  ...
  [5]: {
    [POWER[5].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  },
  [42]: {
    [POWER[42].address]: { type: PermitType.AMOUNT, name: 'SushiSwap' },
  },
}
