...
import { ChainId, Currency, Ether, JSBI, NATIVE, Percent, ROUTER_ADDRESS, Trade, WNATIVE } from '@powerswap/sdk'
        ...
        <Alert
          ...
          message={
            <>
              ...
              there may be very high slippage. ETH, WBTC, USDC, DAI and POWER are the safest tokens to zap with. If
