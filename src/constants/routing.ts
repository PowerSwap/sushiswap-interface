...
import { ChainId, Currency, Token, WNATIVE } from '@powerswap/sdk'
...
export const CUSTOM_BASES: {
  ...
  [ChainId.MATIC]: {
    [MATIC.TEL.address]: [MATIC.POWER, MATIC.AAVE],
  },
}
...
export const PINNED_PAIRS: {
  ...
  [ChainId.MAINNET]: [
    [POWER[ChainId.MAINNET] as Token, WNATIVE[ChainId.MAINNET]],
    [
