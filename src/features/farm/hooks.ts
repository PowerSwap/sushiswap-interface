import { ChainId, CurrencyAmount, JSBI, MASTERCHEF_ADDRESS } from '@powerswap/sdk'
import { Chef, PairType } from './enum'
import { MASTERCHEF_V2_ADDRESS, MINICHEF_ADDRESS, POWER } from '../../constants'
...
export function usePendingSushi(farm) {
  ...
  return amount ? CurrencyAmount.fromRawAmount(POWER[chainId], amount) : undefined
}
