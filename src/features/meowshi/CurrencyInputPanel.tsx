        ...
        <div className="p-5 flex flex-col justify-between space-y-3 sm:space-y-0 sm:flex-row">
          <div className="flex w-full sm:w-2/5 items-center">
            <div className="flex gap-4 items-center">
              <Image
                src={
                  currency === POWER[ChainId.MAINNET]
              ...
              <div className="flex flex-col items-start">
                ...
                {(currency === POWER[ChainId.MAINNET] || currency === XSUSHI) && (
                  <Typography
                    variant="xs"
                    className="underline text-blue cursor-pointer"
                    onClick={() => setCurrency(currency === XSUSHI ? POWER[ChainId.MAINNET] : XSUSHI, field)}
                  >
                    {currencies[field] === POWER[ChainId.MAINNET] ? i18n._(t`Use xSUSHI`) : i18n._(t`Use POWER`)}
                  </Typography>
                )}
              </div>
            </div>
