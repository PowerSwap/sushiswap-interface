...
Each price feed has a pair token0/token1, POWER/ETH or POWER/USD for example, decimals, and proxy. We use this information to construct mappings of the price feed to their respectful pair tokens.
